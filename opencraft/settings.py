...
INSTANCE_LOGS_SERVER_ELASTICSEARCH_HOST = env(
    'INSTANCE_LOGS_SERVER_ELASTICSEARCH_HOST', default=INSTANCE_LOGS_SERVER_HOST
)
INSTANCE_LOGS_SERVER_ELASTICSEARCH_PORT = env('INSTANCE_LOGS_SERVER_ELASTICSEARCH_PORT', default=9200)
INSTANCE_LOGS_SERVER_ELASTICSEARCH_USERNAME = env('INSTANCE_LOGS_SERVER_ELASTICSEARCH_USERNAME', default='elastic')
INSTANCE_LOGS_SERVER_ELASTICSEARCH_PASSWORD = env('INSTANCE_LOGS_SERVER_ELASTICSEARCH_PASSWORD', default='')
INSTANCE_LOGS_SERVER_ELASTICSEARCH_USE_SSL = env('INSTANCE_LOGS_SERVER_ELASTICSEARCH_USE_SSL', default=True)
INSTANCE_LOGS_SERVER_ELASTICSEARCH_CA_CERT = env('INSTANCE_LOGS_SERVER_ELASTICSEARCH_CA_CERT', default='')
...
GROVE_DEFAULT_REPOSITORY_URL = env.str('GROVE_DEFAULT_REPOSITORY_URL')
...
GROVE_INSTANCE_NAME_LENGTH_LIMIT = env.int('GROVE_INSTANCE_NAME_LENGTH_LIMIT', default=49)
