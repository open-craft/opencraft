 ...
 * 
 * @export
 * @interface V1ThemeSchemaSerializerGenerator
 */
export interface V1ThemeSchemaSerializerGenerator {
    /**
     * 
     * @type {number}
     * @memberof V1ThemeSchemaSerializerGenerator
     */
    version: number;
    /**
     * 
...
export function V1ThemeSchemaSerializerGeneratorFromJSON(json: any): V1ThemeSchemaSerializerGenerator {
    return V1ThemeSchemaSerializerGeneratorFromJSONTyped(json, false);
}

export function V1ThemeSchemaSerializerGeneratorFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1ThemeSchemaSerializerGenerator {
...
export function V1ThemeSchemaSerializerGeneratorToJSON(value?: V1ThemeSchemaSerializerGenerator | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
