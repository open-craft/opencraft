    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subdomain', models.CharField(validators=[django.core.validators.RegexValidator('^[\\w.-]+$', "Please include only letters, numbers, '_', '-' and '.'"), betatest.models.validate_available_subdomain], help_text='The URL students will visit. In the future, you will also have the possibility to use your own domain name.\n\nExample: hogwarts.opencraft.hosting', error_messages={'unique': 'This domain is already taken.'}, verbose_name='domain name', unique=True, max_length=255)),
