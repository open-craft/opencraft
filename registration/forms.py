...
class BetaTestApplicationForm(forms.ModelForm):
    """
    This is a temporary class for a form without the django-angular stuff.
    FIXME delete this class and use the one commented below.
    """
    class Meta:
        model = BetaTestApplication
        fields = ('project_description', )

# FIXME reenable these features (port them to the latest django-angular we can use). Remove the temporary BetaTestApplicationForm class
...
# FIXME use this class again, after fixing the django-angular issues
