...
v1_router.register(r'registration/register/validate', BetaTestApplicationViewSet, base_name='register')
...
v2_router.register(r'instances/deployments', OpenEdxInstanceDeploymentViewSet, base_name='deployments')
