# -*- coding: utf-8 -*-
# Generated by Django 1.10.7 on 2018-04-20 16:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='replica_set',
            field=models.ForeignKey(blank=True, help_text='Replica Set to which the server belongs to.', null=True, on_delete=django.db.models.deletion.CASCADE, to='instance.MongoDBReplicaSet'),
        ),
        migrations.AddField(
            model_name='mongodbserver',
            name='primary',
