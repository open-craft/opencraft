...
class RabbitMQInstanceMixin(models.Model):
    ...
    rabbitmq_provider_user = models.ForeignKey(RabbitMQUser, related_name='provider_instance',
                                               on_delete=models.CASCADE, blank=True, null=True)
    rabbitmq_consumer_user = models.ForeignKey(RabbitMQUser, related_name='consumer_instance',
                                               on_delete=models.CASCADE, blank=True, null=True)
    ...
    def provision_rabbitmq(self):
        ...
        """
        if settings.RABBITMQ_ENABLE and not self.rabbitmq_provisioned:
    ...
    def deprovision_rabbitmq(self):
        ...
        """
        if settings.RABBITMQ_ENABLE and self.rabbitmq_provisioned:
