...
class OpenEdXInstanceFactory(DjangoModelFactory):
    ...
    ref_type = 'tags'
    branch_name = 'named-release/dogwood.3' # Use a known working version
    ansible_source_repo_url = 'https://github.com/open-craft/configuration.git'
    configuration_version = 'integration-dogwood'
    ansible_playbook_name = 'opencraft_integration'
    forum_version = 'named-release/dogwood.3'
    notifier_version = 'named-release/dogwood.3'
    xqueue_version = 'named-release/dogwood.3'
    certs_version = 'named-release/dogwood.3'
